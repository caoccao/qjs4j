...
public class Uint8ArrayBase64HexTest extends BaseJavetTest {
    ...
    public void testDescriptorsAndMethods() {
        assertBooleanWithJavet("typeof Uint8Array.fromBase64 === 'function'",
                "typeof Uint8Array.fromHex === 'function'", "typeof Uint8Array.prototype.toBase64 === 'function'",
    ...
    public void testErrors() {
        assertErrorWithJavet("Uint8Array.fromBase64(1)", "Uint8Array.fromBase64('AQ==', { alphabet: 'invalid' })",
                "Uint8Array.fromBase64('A', { lastChunkHandling: 'strict' })", "Uint8Array.fromHex('0')",
                "Uint8Array.fromHex('zz')", "new Uint8Array([1]).toBase64({ alphabet: 'invalid' })",
    ...
    public void testFromAndTo() {
        assertStringWithJavet("Uint8Array.fromBase64('AQID').toString()", "Uint8Array.fromHex('000102ff').toString()",
                "new Uint8Array([1, 2, 3]).toBase64()", "new Uint8Array([1, 2]).toBase64({ omitPadding: true })",
