...
public class StringConstructorTest extends BaseTest {
    ...
    public void testNewStringCreatesJSStringObject() {
        ...
        JSValue result1 = ctx.eval("new String('hello');");
        ...
        JSValue result2 = ctx.eval("new String('world');");
    ...
    public void testStringConstructorWithDifferentValues() {
        ...
        JSValue result3 = ctx.eval("new String(123);");
        ...
        JSValue result6 = ctx.eval("new String(undefined);");
        ...
        JSValue result7 = ctx.eval("new String(null);");
    ...
    public void testStringConstructorWithNoArguments() {
        ...
        JSValue result = ctx.eval("new String();");
    ...
    public void testStringWithoutNewReturnsPrimitive() {
        ...
        JSValue result1 = ctx.eval("String('hello');");
        ...
        JSValue result2 = ctx.eval("String('world');");
