 ...
 */
public class JSPrototypeChainWalkTest extends BaseTest {
    ...
    public void testInstanceofInvokesTheGetPrototypeOfTrap() {
        ...
        assertThat(context.eval(
                """
                        ...
                        'result=' + result + ' trapCalls=' + trapCalls""").toString())
                .isEqualTo("result=true trapCalls=1");
    }
    ...
    public void testProxyInThePrototypeChainStillSeesTheHasTrap() {
        assertThat(context.eval(
                """
                        ...
                        const obj = Object.create(proxyProto);
                        ('viaTrap' in obj) + ',' + ('absent' in obj) + ',' + trapKeys.join('|')""").toString())
                .isEqualTo("true,false,viaTrap|absent");
    }
