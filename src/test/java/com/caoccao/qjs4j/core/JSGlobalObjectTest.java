...
public class JSGlobalObjectTest extends BaseJavetTest {
    ...
    public void testDecodeURIBasicAscii() {
        ...
        assertStringWithJavet("decodeURIComponent('%41')", // A
    ...
    public void testDecodeURIComponentReservedChars() {
        ...
        assertStringWithJavet("decodeURIComponent('%3B')", // ;
    ...
    public void testDecodeURIDecodesUnreservedChars() {
        ...
        assertStringWithJavet("decodeURI('%20')", // space - not reserved, decoded
    ...
    public void testDecodeURIFunctionProperties() {
        ...
        assertStringWithJavet("decodeURIComponent.name", "decodeURI.name");
        assertBooleanWithJavet("decodeURIComponent.length === 1", "decodeURI.length === 1",
                "typeof decodeURIComponent === 'function'", "typeof decodeURI === 'function'");
    }

    @Test
    public void testDecodeURIMixedContent() {
        // Mixed encoded and plain text
        assertStringWithJavet("decodeURIComponent('Hello%20World')", "decodeURIComponent('a%2Bb%20c')",
                "decodeURIComponent('%E4%BD%A0%E5%A5%BDworld')", "decodeURIComponent('test%3Dvalue%26key%3Dother')",
                "decodeURIComponent('100%25%20correct')", "decodeURIComponent('path%2Fto%2Ffile')",
                "decodeURI('https://example.com/a%20b?x=1&y=2#hash')", "decodeURI('%E4%BD%A0%E5%A5%BD')");
    }

    @Test
    public void testDecodeURIPassthrough() {
        // Strings without percent encoding pass through unchanged
        assertStringWithJavet("decodeURIComponent('hello')", "decodeURIComponent('abc123')", "decodeURIComponent('')",
                "decodeURIComponent('no-encoding-here')", "decodeURIComponent('ABCxyz')", "decodeURI('hello')",
                "decodeURI('')");
    }
    ...
    public void testDecodeURIPreservesReservedChars() {
        ...
        assertStringWithJavet("decodeURI('%3B')", // ; - reserved, stays encoded
    ...
    public void testDecodeURIRoundTrip() {
        ...
        assertBooleanWithJavet("decodeURIComponent(encodeURIComponent('Hello World')) === 'Hello World'",
    ...
    public void testDecodeURITypeCoercion() {
        ...
        assertStringWithJavet("decodeURIComponent(42)", "decodeURIComponent(true)", "decodeURIComponent(false)",
                "decodeURIComponent(null)", "decodeURI(42)", "decodeURI(null)");
    }

    @Test
    public void testDecodeURIUndefinedInput() {
        // undefined input - should return "undefined"
        assertStringWithJavet("decodeURIComponent()", "decodeURIComponent(undefined)", "decodeURI()",
                "decodeURI(undefined)");
    }
    ...
    public void testDecodeURIUtf8FourByte() {
        ...
        assertStringWithJavet("decodeURIComponent('%F0%9F%98%80')", // 😀 (U+1F600)
    ...
    public void testDecodeURIUtf8ThreeByte() {
        ...
        assertStringWithJavet("decodeURIComponent('%E4%B8%AD')", // 中 (U+4E2D)
    ...
    public void testDecodeURIUtf8TwoByte() {
        ...
        assertStringWithJavet("decodeURIComponent('%C2%A2')", // ¢ (U+00A2)
    ...
    public void testEscape() {
        assertStringWithJavet(
                ...
                "escape('abc')", "escape('ABC')", "escape('123')", "escape('@*_+-./')",
                // Test characters that should be escaped with %XX format
                "escape('Hello World')", "escape('a b c')", "escape('!#$%&()=')", "escape('a=b&c=d')",
                "escape('test:value')", "escape('<script>')",
                // Test Unicode characters (should use %uXXXX format)
                "escape('你好')", "escape('世界')", "escape('Hello 世界')", "escape('abc中def')",
                // Test empty string
                "escape('')",
                // Test special cases
                "escape('100% correct')", "escape('email@domain.com')", "escape('path/to/file.txt')",
    ...
    public void testEscapeUnescapeRoundTrip() {
        ...
        assertStringWithJavet("unescape(escape('Hello World'))", "unescape(escape('test@example.com'))",
                "unescape(escape('a=b&c=d'))", "unescape(escape('你好世界'))", "unescape(escape('Hello 世界!'))",
                "unescape(escape('!@#$%^&*()'))", "unescape(escape(''))");
    }
    ...
    public void testGlobalDescriptorsAndTagWithQuickJSSemantics() {
        assertBooleanWithJavet("Object.getOwnPropertyDescriptor(globalThis, 'parseInt').writable === true",
        ...
        assertThat(context.eval("Object.prototype.toString.call(globalThis)").toJavaObject())
                .isEqualTo("[object global]");
    }

    @Test
    public void testGlobalFunctionDescriptorsForUriAndNumericParsing() {
        assertBooleanWithJavet("Object.getOwnPropertyDescriptor(globalThis, 'decodeURI').writable === true",
                ...
                "Object.getOwnPropertyDescriptor(globalThis, 'parseInt').writable === true", "decodeURI.length === 1",
                "decodeURIComponent.length === 1", "encodeURI.length === 1", "encodeURIComponent.length === 1",
                "escape.length === 1", "unescape.length === 1", "isFinite.length === 1", "isNaN.length === 1",
                "parseFloat.length === 1", "parseInt.length === 2");
    }

    @Test
    public void testGlobalFunctionErrorsWithQuickJSSemantics() {
        String[] codeArray = {"new parseInt()", "new isNaN()", "new decodeURI()", "isNaN(Symbol())",
                "isFinite(Symbol())", "isNaN(1n)", "isFinite(1n)", "isNaN(Object(Symbol()))",
                "isFinite(Object(Symbol()))", "isNaN(Object(1n))", "isFinite(Object(1n))"};
        for (String code : codeArray) {
            assertThatThrownBy(() -> context.eval(code)).as(code).isInstanceOf(JSException.class)
    ...
    public void testIdentifierResolutionWithReferenceErrorAndTypeof() {
        assertThatThrownBy(() -> context.eval("missingIdentifier;")).isInstanceOf(JSException.class)
    ...
    public void testParseFloatEdgeCasesWithJavet() {
        assertBooleanWithJavet("Object.is(parseFloat('1e'), 1)", "Object.is(parseFloat('1e+'), 1)",
                "Object.is(parseFloat('-0x1'), -0)", "Object.is(parseFloat('+.8xyz'), 0.8)",
                "Object.is(parseFloat('InfinityandMore'), Infinity)",
                "Object.is(parseFloat('-Infinity-and-more'), -Infinity)", "Number.isNaN(parseFloat('.'))",
                "Number.isNaN(parseFloat('+.'))", "Number.isNaN(parseFloat('e10'))");
    }

    @Test
    public void testParseIntEdgeCasesWithJavet() {
        assertBooleanWithJavet("Object.is(parseInt('10', Infinity), 10)", "Object.is(parseInt('10', -Infinity), 10)",
                "Object.is(parseInt('10', 4294967298), 2)", "Object.is(parseInt('0x10', 17), 0)",
                "Object.is(parseInt('  -0xF'), -15)", "Object.is(parseInt('+0x10', 16), 16)",
                "Object.is(parseInt('123xyz', 10), 123)", "Number.isNaN(parseInt('１２３', 10))",
                "Number.isNaN(parseInt('', 10))", "Number.isNaN(parseInt('+', 10))");
        assertStringWithJavet(
    ...
    public void testUnescape() {
        assertStringWithJavet(
                ...
                "unescape('%20')", "unescape('%21')", "unescape('%40')",
                // Test %uXXXX sequences for Unicode
                "unescape('%u4F60')", "unescape('%u597D')", "unescape('%u4F60%u597D')",
                // Test mixed sequences
                "unescape('Hello%20World')", "unescape('%21%23%24')", "unescape('test%3Avalue')",
                // Test strings without escape sequences
                "unescape('abc')", "unescape('123')", "unescape('')",
                // Test invalid sequences (should be treated as literals)
                "unescape('%')", "unescape('%Z')", "unescape('%uGGGG')",
    ...
    public void testUriEncodeDecodeEdgeCasesWithJavet() {
        assertStringWithJavet("encodeURI('https://example.com/a b?x=1&y=#hash')", "encodeURI(';/?:@&=+$,#')",
                "encodeURIComponent(';/?:@&=+$,#')", "encodeURIComponent('a+b c')",
                "decodeURI('https://example.com/a%20b?x=%23#hash')", "decodeURIComponent('a%2Bb%20c%2F%3F%23')",
                "decodeURIComponent('%F0%9F%98%80')", "decodeURI('%E4%BD%A0%E5%A5%BD')");
        assertStringWithJavet("(() => { try { decodeURI('%'); return 'no error'; } catch (e) { return e.name; } })()",
