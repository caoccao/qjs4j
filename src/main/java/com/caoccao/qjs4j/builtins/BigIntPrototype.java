...
/**
 * Implementation of BigInt.prototype methods. Based on ES2020 BigInt specification.
 */
public final class BigIntPrototype {
    /**
     * BigInt.prototype.toLocaleString(locales, options) ES2024 21.2.3.2 Delegates to Intl.NumberFormat per the
     * specification: 1. Let x = thisBigIntValue(this) 2. Let numberFormat = Construct(%NumberFormat%, [locales,
     * options]) 3. Return FormatNumeric(numberFormat, x)
     */
    public static JSValue toLocaleString(JSContext context, JSValue thisArg, JSValue[] args) {
        return thisArg.asBigIntWithDownCast().map(jsBigInt -> {
    ...
    /**
     * BigInt.prototype.toString(radix) ES2020 20.2.3.3 Returns a string representation of the BigInt in the specified
     * radix.
     */
    ...
    /**
     * BigInt.prototype.valueOf() ES2020 20.2.3.4 Returns the primitive value of the BigInt.
     */
    public static JSValue valueOf(JSContext context, JSValue thisArg, JSValue[] args) {
        return thisArg.asBigIntWithDownCast().map(jsBigInt -> (JSValue) jsBigInt)
