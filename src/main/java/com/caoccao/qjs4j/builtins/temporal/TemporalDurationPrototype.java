...
public final class TemporalDurationPrototype {
    ...
    private static final BigInteger MAX_FLOAT64_MICROSECONDS_COMPONENT = new BigInteger("9007199254740991475711");
    private static final BigInteger MAX_FLOAT64_MILLISECONDS_COMPONENT = new BigInteger("9007199254740991487");
    private static final BigInteger MAX_FLOAT64_NANOSECONDS_COMPONENT = new BigInteger("9007199254740991463129087");
    ...
    public static JSValue abs(JSContext context, JSValue thisArg, JSValue[] args) {
        JSTemporalDuration duration = TemporalUtils.checkReceiver(context, thisArg, JSTemporalDuration.class, TYPE_NAME,
                "abs");
        if (duration == null) {
    ...
    private static JSValue addOrSubtract(JSContext context, JSTemporalDuration duration, JSValue[] args, int sign) {
        ...
        if (leftRecord.hasCalendarUnits() || rightRecord.hasCalendarUnits()) {
            context.throwRangeError(
                    "Temporal error: A starting point is required for years, months, or weeks arithmetic.");
            return JSUndefined.INSTANCE;
        }
    ...
    private static void applyDurationFieldOverrides(JSTemporalDuration duration,
            TemporalDurationDouble durationFieldOverrides) {
        duration.defineProperty(PropertyKey.fromString("years"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.years())));
        duration.defineProperty(PropertyKey.fromString("months"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.months())));
        duration.defineProperty(PropertyKey.fromString("weeks"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.weeks())));
        duration.defineProperty(PropertyKey.fromString("days"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.days())));
        duration.defineProperty(PropertyKey.fromString("hours"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.hours())));
        duration.defineProperty(PropertyKey.fromString("minutes"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.minutes())));
        duration.defineProperty(PropertyKey.fromString("seconds"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.seconds())));
        duration.defineProperty(PropertyKey.fromString("milliseconds"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.milliseconds())));
        duration.defineProperty(PropertyKey.fromString("microseconds"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.microseconds())));
        duration.defineProperty(PropertyKey.fromString("nanoseconds"),
                PropertyDescriptor.defaultData(JSNumber.of(durationFieldOverrides.nanoseconds())));
    }

    private static TemporalDuration balanceZonedDurationWithoutRounding(JSContext context,
            TemporalDuration durationRecord, TemporalRelativeToOption relativeToOption) {
        LocalDateTime dayBalanceAnchorDateTime = relativeToOption.startDateTime().plusYears(durationRecord.years())
        ...
        while (remainingTimeNanoseconds.signum() != 0) {
            ...
            BigInteger oneDayNanoseconds = nanosecondsBetween(context, dayBalanceAnchorDateTime, null,
                    adjacentDayDateTime, null, relativeToOption).abs();
            if (context.hasPendingException()) {
                return null;
            }
        ...
        TemporalDuration balancedTimeDuration = TemporalDuration.createBalance(remainingTimeNanoseconds,
                TemporalUnit.HOUR);
        ...
        return new TemporalDuration(durationRecord.years(), durationRecord.months(), durationRecord.weeks(),
                balancedDayCount, balancedTimeDuration.hours(), balancedTimeDuration.minutes(),
                balancedTimeDuration.seconds(), balancedTimeDuration.milliseconds(),
                balancedTimeDuration.microseconds(), balancedTimeDuration.nanoseconds());
    }
    ...
    private static TemporalDuration buildBalancedDurationFromDateTimes(JSContext context, LocalDateTime startDateTime,
            LocalDateTime endDateTime, TemporalUnit largestUnit, TemporalUnit smallestUnit,
            TemporalRelativeToOption relativeToOption) {
        if (largestUnit.isTimeUnit()) {
            BigInteger totalNanoseconds = nanosecondsBetween(context, startDateTime, null, endDateTime, null,
                    relativeToOption);
            if (context.hasPendingException()) {
                return null;
            }
        ...
        if (largestUnit == TemporalUnit.YEAR) {
            long yearStepCount = TemporalUnit.YEAR.moveByWholeCalendarUnits(cursorDateTime, endDateTime);
            years = yearStepCount;
        ...
        if (largestUnit == TemporalUnit.YEAR || largestUnit == TemporalUnit.MONTH) {
            long monthStepCount = TemporalUnit.MONTH.moveByWholeCalendarUnits(cursorDateTime, endDateTime);
        ...
        if (shouldBalanceWeeks) {
            ...
            if (relativeToOption != null && relativeToOption.zoned()) {
                weekStepCount = TemporalUnit.WEEK.moveByWholeCalendarUnitsWithRelativeTo(context, cursorDateTime,
                        endDateTime, relativeToOption);
                if (context.hasPendingException()) {
                    return null;
                }
                cursorDateTime = TemporalUnit.WEEK.addCalendarUnits(cursorDateTime, weekStepCount);
            } else {
                weekStepCount = TemporalUnit.WEEK.moveByWholeFixedUnits(cursorDateTime, endDateTime);
        ...
        if (smallestUnitRank >= TemporalUnit.DAY.rank()) {
            long dayStepCount;
            if (relativeToOption != null && relativeToOption.zoned()) {
                dayStepCount = TemporalUnit.DAY.moveByWholeCalendarUnitsWithRelativeTo(context, cursorDateTime,
                        endDateTime, relativeToOption);
                if (context.hasPendingException()) {
                    return null;
                }
                ...
                dayStepCount = TemporalUnit.DAY.moveByWholeFixedUnits(cursorDateTime, endDateTime);
        ...
        BigInteger remainingNanoseconds = nanosecondsBetween(context, cursorDateTime, null, endDateTime, null,
                relativeToOption);
        if (context.hasPendingException()) {
            return null;
        }
        TemporalDuration timeDuration = TemporalDuration.createBalance(remainingNanoseconds, TemporalUnit.HOUR);
        TemporalDuration durationRecord = new TemporalDuration(years, months, weeks, days, timeDuration.hours(),
                timeDuration.minutes(), timeDuration.seconds(), timeDuration.milliseconds(),
    ...
    private static TemporalUnit canonicalizeDurationToStringSmallestUnit(JSContext context, String unitText) {
        TemporalUnit smallestUnit = TemporalUnit.fromString(unitText)
                .filter(unit -> !unit.isLargerThan(TemporalUnit.SECOND)).orElse(null);
    ...
    private static TemporalUnit canonicalizeTemporalDurationUnit(JSContext context, String unitText,
            String optionName) {
    ...
    static TemporalDuration differencePlainDateTime(JSContext context, IsoDateTime startIsoDateTime,
            IsoDateTime endIsoDateTime, TemporalUnit largestUnit, TemporalUnit smallestUnit, long roundingIncrement,
        ...
        TemporalDuration unroundedDuration = buildBalancedDurationFromDateTimes(context, startDateTime, endDateTime,
                largestUnit, TemporalUnit.NANOSECOND, null);
        ...
        TemporalRelativeToOption relativeToOption = new TemporalRelativeToOption(startDateTime, false, null, null,
                null);
        TemporalRoundOptions roundOptions = new TemporalRoundOptions(smallestUnit, largestUnit, roundingIncrement,
                roundingMode, relativeToOption);
        LocalDateTime roundedEndDateTime = roundDateTimeDifference(context, startDateTime, endDateTime, null,
                roundOptions, relativeToOption, unroundedDuration);
        if (context.hasPendingException() || roundedEndDateTime == null) {
            return null;
        }

        return buildBalancedDurationFromDateTimes(context, startDateTime, roundedEndDateTime, largestUnit, smallestUnit,
                null);
    }

    static TemporalDuration differenceZonedDateTime(JSContext context, BigInteger startEpochNanoseconds,
            BigInteger endEpochNanoseconds, String timeZoneId, TemporalUnit largestUnit, TemporalUnit smallestUnit,
            long roundingIncrement, TemporalRoundingMode roundingMode) {
        IsoDateTime startIsoDateTime = IsoDateTime.createFromEpochNsAndTimeZoneId(startEpochNanoseconds, timeZoneId);
        IsoDateTime endIsoDateTime = IsoDateTime.createFromEpochNsAndTimeZoneId(endEpochNanoseconds, timeZoneId);
        LocalDateTime startDateTime = startIsoDateTime.toLocalDateTime();
        LocalDateTime endDateTime = endIsoDateTime.toLocalDateTime();
        TemporalRelativeToOption relativeToOption = new TemporalRelativeToOption(startDateTime, true,
                startEpochNanoseconds, timeZoneId, null);

        TemporalDuration unroundedDuration = buildBalancedDurationFromDateTimes(context, startDateTime, endDateTime,
                largestUnit, TemporalUnit.NANOSECOND, relativeToOption);
        if (context.hasPendingException() || unroundedDuration == null) {
            return null;
        }
        ...
        TemporalRoundOptions roundOptions = new TemporalRoundOptions(smallestUnit, largestUnit, roundingIncrement,
                roundingMode, relativeToOption);
        LocalDateTime roundedEndDateTime = roundDateTimeDifference(context, startDateTime, endDateTime,
                endEpochNanoseconds, roundOptions, relativeToOption, unroundedDuration);
        if (context.hasPendingException() || roundedEndDateTime == null) {
            return null;
        }
    ...
    private static double divideBigIntegersToDouble(BigInteger numerator, BigInteger divisor) {
        ...
        BigDecimal quotient = new BigDecimal(normalizedNumerator).divide(new BigDecimal(normalizedDivisor),
                java.math.MathContext.DECIMAL128);
        return quotient.doubleValue();
    }

    private static long getRoundingIncrementOption(JSContext context, JSObject optionsObject, String optionName,
            long defaultValue, long minimumValue, long maximumValue, String invalidOptionMessage) {
    ...
    private static BigInteger nanosecondsBetween(JSContext context, LocalDateTime startDateTime,
            BigInteger knownStartEpochNanoseconds, LocalDateTime endDateTime, BigInteger knownEndEpochNanoseconds,
            TemporalRelativeToOption relativeToOption) {
        if (relativeToOption == null || !relativeToOption.zoned()) {
    ...
    private static TemporalDurationToStringOptions parseDurationToStringOptions(JSContext context,
            JSValue optionsValue) {
        JSObject optionsObject = TemporalUtils.toOptionalOptionsObject(context, optionsValue,
        ...
        TemporalFractionalSecondDigitsOption fractionalSecondDigitsOption = TemporalFractionalSecondDigitsOption
                .parse(context, fractionalSecondDigitsValue, "Temporal error: Invalid fractionalSecondDigits.");
        ...
        return new TemporalDurationToStringOptions(smallestUnitForOptions, roundingMode, roundingIncrementNanoseconds,
                precisionAuto, fractionalSecondDigits);
    }

    private static TemporalRoundOptions parseRoundOptions(JSContext context, JSValue roundToArg,
        ...
        if (roundToArg instanceof JSString smallestUnitStringValue) {
            ...
            roundingIncrement = getRoundingIncrementOption(context, optionsObject, "roundingIncrement", 1L, 1L,
                    1_000_000_000L, "Temporal error: Invalid rounding increment.");
            if (context.hasPendingException()) {
                return null;
            }
        ...
        if (roundingIncrement != 1 && smallestRoundUnit.isDateUnit()
                && largestRoundUnit.rank() < smallestRoundUnit.rank()) {
            context.throwRangeError("Temporal error: Invalid rounding increment.");
            return null;
        }

        return new TemporalRoundOptions(smallestRoundUnit, largestRoundUnit, roundingIncrement, roundingMode,
                relativeToOption);
    }
    ...
    private static TemporalRelativeToOption parseRoundRelativeToOption(JSContext context, JSValue relativeToValue) {
        ...
        TemporalDurationConstructor.RelativeToReference relativeToReference = TemporalDurationConstructor
                .parseRelativeToValue(context, relativeToValue);
        ...
        if (relativeToReference.epochNanoseconds() == null || relativeToReference.timeZoneId() == null) {
            LocalDateTime startDateTime = relativeToReference.relativeDate().atTime(relativeToReference.relativeTime())
                    .toLocalDateTime();
        ...
        if (TemporalUtils.isOffsetTimeZoneIdentifier(relativeToReference.timeZoneId())) {
            ...
            localIsoDateTime = IsoDateTime.createFromEpochNsAndTimeZoneId(relativeToReference.epochNanoseconds(),
                    relativeToReference.timeZoneId());
        }
        LocalDateTime startDateTime = localIsoDateTime.toLocalDateTime();
        return new TemporalRelativeToOption(startDateTime, true, relativeToReference.epochNanoseconds(),
                relativeToReference.timeZoneId(), relativeToReference.offsetSeconds());
    }

    private static TemporalPartialDurationFieldValue readPartialDurationField(JSContext context, JSObject fields,
            String fieldKey) {
    ...
    public static JSValue round(JSContext context, JSValue thisArg, JSValue[] args) {
        ...
        boolean requiresRelativeTo = durationRecord.hasCalendarUnits()
                || roundOptions.smallestUnit().requiresRelativeTo() || roundOptions.largestUnit().requiresRelativeTo();
        ...
        if (relativeToOption == null) {
            ...
            TemporalDuration roundedDurationRecord = roundWithRelativeTo(context, durationRecord, roundOptions,
                    relativeToOption);
            roundComputationResult = new TemporalRoundComputationResult(roundedDurationRecord, null);
        }
        if (context.hasPendingException() || roundComputationResult == null
                || roundComputationResult.durationRecord() == null) {
            return JSUndefined.INSTANCE;
        }

        TemporalDuration normalizedDurationRecord = roundComputationResult.durationRecord()
                .normalizeFloat64RepresentableFields();
        if (!normalizedDurationRecord.isValid()
                || !TemporalDuration.isDurationRecordTimeRangeValid(normalizedDurationRecord)) {
            context.throwRangeError("Temporal error: Duration field out of range.");
            return JSUndefined.INSTANCE;
        }
    ...
    private static LocalDateTime roundDateTimeDifference(JSContext context, LocalDateTime startDateTime,
            LocalDateTime unroundedEndDateTime, BigInteger unroundedEndEpochNanoseconds,
            TemporalRoundOptions roundOptions, TemporalRelativeToOption relativeToOption,
            TemporalDuration durationRecord) {
        ...
        if (smallestUnit == TemporalUnit.YEAR || smallestUnit == TemporalUnit.MONTH) {
            return roundDateTimeToCalendarUnit(context, startDateTime, unroundedEndDateTime,
                    unroundedEndEpochNanoseconds, smallestUnit, roundingIncrement, roundingMode, relativeToOption);
        }

        if (smallestUnit == TemporalUnit.WEEK && (largestUnit == TemporalUnit.YEAR || largestUnit == TemporalUnit.MONTH
                || largestUnit == TemporalUnit.WEEK)) {
            LocalDateTime weekAnchorDateTime = startDateTime;
            if (largestUnit == TemporalUnit.YEAR) {
                long yearStepCount = TemporalUnit.YEAR.moveByWholeCalendarUnits(weekAnchorDateTime,
                        unroundedEndDateTime);
                weekAnchorDateTime = TemporalUnit.YEAR.addCalendarUnits(weekAnchorDateTime, yearStepCount);
                long monthStepCount = TemporalUnit.MONTH.moveByWholeCalendarUnits(weekAnchorDateTime,
                        unroundedEndDateTime);
            ...
            BigInteger weekRemainderNanoseconds = nanosecondsBetween(context, weekAnchorDateTime, null,
                    unroundedEndDateTime, unroundedEndEpochNanoseconds, relativeToOption);
            BigInteger weekIncrementNanoseconds = WEEK_NANOSECONDS.multiply(BigInteger.valueOf(roundingIncrement));
            BigInteger roundedWeekRemainderNanoseconds = roundingMode
                    .roundBigIntegerToIncrementSigned(weekRemainderNanoseconds, weekIncrementNanoseconds);
            return IsoDateTime.createFromLocalDateTime(weekAnchorDateTime).addNanosecondsToDateTime(context,
                    roundedWeekRemainderNanoseconds, relativeToOption);
        }
        ...
        if (relativeToOption.zoned() && smallestUnit.isTimeUnit() && !durationRecord.hasAnyDateUnits()
                && !largestUnit.isTimeUnit()) {
            TemporalDuration balancedDurationWithoutRounding = balanceZonedDurationWithoutRounding(context,
                    durationRecord, relativeToOption);
            ...
            BigInteger daySpanNanoseconds = nanosecondsBetween(context, startAnchorDateTime, null, endAnchorDateTime,
                    null, relativeToOption);
            if (context.hasPendingException()) {
                return null;
            }
            ...
            if (roundedBeyondOneDay) {
                roundedTimeNanoseconds = roundingMode.roundBigIntegerToIncrementSigned(beyondDaySpanNanoseconds,
                        unitToNanosecondsBigInteger(smallestUnit).multiply(BigInteger.valueOf(roundingIncrement)));
                return IsoDateTime.createFromLocalDateTime(endAnchorDateTime).addNanosecondsToDateTime(context,
                        roundedTimeNanoseconds, relativeToOption);
            }
            return IsoDateTime.createFromLocalDateTime(startAnchorDateTime).addNanosecondsToDateTime(context,
                    roundedTimeNanoseconds, relativeToOption);
        }
        ...
        if (relativeToOption.zoned() && smallestUnit.isTimeUnit() && durationRecord.hasAnyDateUnits()
            ...
            try {
                dayAdjustedDateTime = startDateTime.plusYears(durationRecord.years())
                        .plusMonths(durationRecord.months()).plusWeeks(durationRecord.weeks())
                        .plusDays(durationRecord.days());
            } catch (DateTimeException dateTimeException) {
                context.throwRangeError("Temporal error: Duration field out of range.");
                return null;
            }
            BigInteger timeRemainderNanoseconds = nanosecondsBetween(context, dayAdjustedDateTime, null,
                    unroundedEndDateTime, unroundedEndEpochNanoseconds, relativeToOption);
            BigInteger incrementNanoseconds = unitToNanosecondsBigInteger(smallestUnit)
                    .multiply(BigInteger.valueOf(roundingIncrement));
            BigInteger roundedTimeRemainderNanoseconds = roundingMode
                    .roundBigIntegerToIncrementSigned(timeRemainderNanoseconds, incrementNanoseconds);
            return IsoDateTime.createFromLocalDateTime(dayAdjustedDateTime).addNanosecondsToDateTime(context,
                    roundedTimeRemainderNanoseconds, relativeToOption);
        }

        BigInteger totalNanoseconds = nanosecondsBetween(context, startDateTime, null, unroundedEndDateTime,
                unroundedEndEpochNanoseconds, relativeToOption);
        BigInteger incrementNanoseconds;
        if (relativeToOption.zoned() && smallestUnit == TemporalUnit.DAY) {
            return roundDateTimeToCalendarUnit(context, startDateTime, unroundedEndDateTime,
                    unroundedEndEpochNanoseconds, TemporalUnit.DAY, roundingIncrement, roundingMode, relativeToOption);
            ...
            incrementNanoseconds = unitToNanosecondsBigInteger(smallestUnit)
                    .multiply(BigInteger.valueOf(roundingIncrement));
        }
        BigInteger roundedNanoseconds = roundingMode.roundBigIntegerToIncrementSigned(totalNanoseconds,
                incrementNanoseconds);
        return IsoDateTime.createFromLocalDateTime(startDateTime).addNanosecondsToDateTime(context, roundedNanoseconds,
                relativeToOption);
    }

    private static LocalDateTime roundDateTimeToCalendarUnit(JSContext context, LocalDateTime startDateTime,
            LocalDateTime endDateTime, BigInteger knownEndEpochNanoseconds, TemporalUnit calendarUnit,
            long roundingIncrement, TemporalRoundingMode roundingMode, TemporalRelativeToOption relativeToOption) {
        long truncatedCount = calendarUnit.moveByWholeCalendarUnits(startDateTime, endDateTime);
        if (relativeToOption != null && relativeToOption.zoned()) {
            truncatedCount = calendarUnit.moveByWholeCalendarUnitsWithRelativeTo(context, startDateTime, endDateTime,
                    relativeToOption);
            if (context.hasPendingException()) {
                return null;
            }
        ...
        if (relativeToOption != null && relativeToOption.zoned()) {
            BigInteger boundaryToEndNanoseconds = nanosecondsBetween(context, truncatedBoundaryDateTime, null,
                    endDateTime, knownEndEpochNanoseconds, relativeToOption);
            if (context.hasPendingException()) {
                return null;
            }
        ...
        int direction;
        if (relativeToOption != null && relativeToOption.zoned()) {
            BigInteger startToEndNanoseconds = nanosecondsBetween(context, startDateTime, null, endDateTime,
                    knownEndEpochNanoseconds, relativeToOption);
            if (context.hasPendingException()) {
                return null;
            }
        ...
        switch (roundingMode) {
            ...
            case HALF_CEIL :
            case HALF_FLOOR :
                BigInteger lowerDistanceNanoseconds = nanosecondsBetween(context, lowerBoundaryDateTime, null,
                        endDateTime, null, relativeToOption).abs();
                BigInteger upperDistanceNanoseconds = nanosecondsBetween(context, endDateTime, null,
                        upperBoundaryDateTime, null, relativeToOption).abs();
    ...
    private static TemporalRoundComputationResult roundWithoutRelativeTo(JSContext context,
            TemporalDuration durationRecord, TemporalRoundOptions roundOptions) {
        ...
        BigInteger incrementNanoseconds = roundingUnitNanoseconds
                .multiply(BigInteger.valueOf(roundOptions.roundingIncrement()));
        BigInteger roundedNanoseconds = roundOptions.roundingMode().roundBigIntegerToIncrementSigned(totalNanoseconds,
                incrementNanoseconds);
        ...
        if (roundOptions.largestUnit() == TemporalUnit.MILLISECOND) {
            ...
            BigInteger microsecondRemainder = roundedNanoseconds.remainder(MILLISECOND_NANOSECONDS)
                    .divide(MICROSECOND_NANOSECONDS);
            BigInteger nanosecondRemainder = roundedNanoseconds.remainder(MICROSECOND_NANOSECONDS);
            durationFieldOverrides = new TemporalDurationDouble(0D, 0D, 0D, 0D, 0D, 0D, 0D,
                    millisecondValue.doubleValue(), microsecondRemainder.doubleValue(),
            ...
            BigInteger nanosecondRemainder = roundedNanoseconds.remainder(MICROSECOND_NANOSECONDS);
            durationFieldOverrides = new TemporalDurationDouble(0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D,
                    microsecondValue.doubleValue(), nanosecondRemainder.doubleValue());
            ...
            durationFieldOverrides = new TemporalDurationDouble(0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D, 0D,
        ...
        TemporalDuration balancedTimeDuration = TemporalDuration.createBalance(roundedNanoseconds,
                balancingLargestUnit);
        return new TemporalRoundComputationResult(balancedTimeDuration, durationFieldOverrides);
    }

    private static TemporalDuration roundWithRelativeTo(JSContext context, TemporalDuration durationRecord,
            TemporalRoundOptions roundOptions, TemporalRelativeToOption relativeToOption) {
        LocalDateTime startDateTime = relativeToOption.startDateTime();
        if (!relativeToOption.zoned() && !durationRecord.isBlank()
        ...
        if (relativeToOption.zoned()) {
            TemporalZonedDateTimeComputation zonedDateTimeComputation = durationRecord
                    .addDurationToZonedDateTime(context, relativeToOption);
            ...
            unroundedEndDateTime = IsoDateTime.createFromLocalDateTime(startDateTime)
                    .addDurationToLocalDateTime(context, durationRecord);
        }
        if (context.hasPendingException()) {
            return null;
        }
        ...
        if (relativeToOption.zoned() && noRoundingRequested && durationRecord.months() == 0L
                && durationRecord.weeks() == 0L && durationRecord.days() == 0L
                && !roundOptions.largestUnit().isTimeUnit()) {
            return balanceZonedDurationWithoutRounding(context, durationRecord, relativeToOption);
        }

        LocalDateTime roundedEndDateTime = roundDateTimeDifference(context, startDateTime, unroundedEndDateTime,
                unroundedEndEpochNanoseconds, roundOptions, relativeToOption, durationRecord);
        if (context.hasPendingException()) {
            return null;
        }

        if (relativeToOption.zoned() && roundOptions.largestUnit().isTimeUnit()) {
            BigInteger roundedNanoseconds = nanosecondsBetween(context, startDateTime, null, roundedEndDateTime, null,
                    relativeToOption);
            if (context.hasPendingException()) {
                return null;
            }
        ...
        return buildBalancedDurationFromDateTimes(context, startDateTime, roundedEndDateTime,
                roundOptions.largestUnit(), roundOptions.smallestUnit(), relativeToOption);
    }
    ...
    public static JSValue toLocaleString(JSContext context, JSValue thisArg, JSValue[] args) {
        ...
        JSValue durationFormat = JSIntlObject.createDurationFormat(context, null, new JSValue[]{locales, options});
        if (context.hasPendingException()) {
            return JSUndefined.INSTANCE;
        }
    ...
    public static JSValue toStringMethod(JSContext context, JSValue thisArg, JSValue[] args) {
        ...
        BigInteger roundedDayTimeNanoseconds = options.roundingMode()
                .roundBigIntegerToIncrementSigned(dayTimeNanoseconds, incrementNanoseconds);
        ...
        TemporalDuration balancedDayTime = TemporalDuration.createBalance(roundedDayTimeNanoseconds,
                largestBalancingUnit);
        TemporalDuration roundedDurationRecord = new TemporalDuration(durationRecord.years(), durationRecord.months(),
                durationRecord.weeks(), balancedDayTime.days(), balancedDayTime.hours(), balancedDayTime.minutes(),
                balancedDayTime.seconds(), balancedDayTime.milliseconds(), balancedDayTime.microseconds(),
    ...
    private static double totalCalendarUnitBetween(JSContext context, LocalDateTime startDateTime,
            LocalDateTime endDateTime, TemporalUnit calendarUnit, TemporalRelativeToOption relativeToOption,
            BigInteger endEpochNanoseconds) {
        ...
        long direction;
        if (zoned) {
            BigInteger deltaNanoseconds = nanosecondsBetween(context, startDateTime,
                    relativeToOption.epochNanoseconds(), endDateTime, endEpochNanoseconds, relativeToOption);
            if (context.hasPendingException()) {
                return Double.NaN;
            }
        ...
        BigInteger remainderNanoseconds = nanosecondsBetween(context, boundaryDateTime,
                boundaryDateTime.equals(startDateTime) && zoned ? relativeToOption.epochNanoseconds() : null,
                endDateTime,
                endDateTime.equals(startDateTime) && zoned ? relativeToOption.epochNanoseconds() : endEpochNanoseconds,
                relativeToOption).abs();
        BigInteger intervalNanoseconds = nanosecondsBetween(context, boundaryDateTime,
                boundaryDateTime.equals(startDateTime) && zoned ? relativeToOption.epochNanoseconds() : null,
                nextBoundaryDateTime, null, relativeToOption).abs();
        BigDecimal fraction = new BigDecimal(remainderNanoseconds).divide(new BigDecimal(intervalNanoseconds),
                java.math.MathContext.DECIMAL128);
    ...
    private static double totalWithoutRelativeTo(JSContext context, TemporalDuration durationRecord,
            TemporalUnit unit) {
    ...
    private static double totalWithRelativeTo(JSContext context, TemporalDuration durationRecord, TemporalUnit unit,
            TemporalRelativeToOption relativeToOption) {
        LocalDateTime startDateTime = relativeToOption.startDateTime();
        if (!relativeToOption.zoned() && !durationRecord.isBlank()
        ...
        if (relativeToOption.zoned()) {
            ...
            endDateTime = IsoDateTime.createFromLocalDateTime(startDateTime).addDurationToLocalDateTime(context,
                    durationRecord);
        }
        if (context.hasPendingException()) {
            return Double.NaN;
        ...
        if (unit.isDateUnit()) {
            return totalCalendarUnitBetween(context, startDateTime, endDateTime, unit, relativeToOption,
                    endEpochNanoseconds);
        }
    ...
    private static BigInteger unitToNanosecondsBigInteger(String unit) {
        return TemporalUnit.fromString(unit).map(temporalUnit -> switch (temporalUnit) {
            case WEEK -> WEEK_NANOSECONDS;
            case DAY -> DAY_NANOSECONDS;
            case HOUR -> HOUR_NANOSECONDS;
            case MINUTE -> MINUTE_NANOSECONDS;
    ...
    public static JSValue valueOf(JSContext context, JSValue thisArg, JSValue[] args) {
        context.throwTypeError(
                "Do not use Temporal.Duration.prototype.valueOf; use Temporal.Duration.prototype.compare for comparison.");
        return JSUndefined.INSTANCE;
    }
    ...
    public static JSValue with(JSContext context, JSValue thisArg, JSValue[] args) {
        ...
        TemporalPartialDurationFieldValue microsecondsFieldValue = readPartialDurationField(context, fields,
                "microseconds");
        if (context.hasPendingException() || microsecondsFieldValue == null) {
            return JSUndefined.INSTANCE;
        }
        TemporalPartialDurationFieldValue millisecondsFieldValue = readPartialDurationField(context, fields,
                "milliseconds");
        ...
        TemporalPartialDurationFieldValue nanosecondsFieldValue = readPartialDurationField(context, fields,
                "nanoseconds");
        ...
        boolean hasAnyDefinedFields = daysFieldValue.present() || hoursFieldValue.present()
                || microsecondsFieldValue.present() || millisecondsFieldValue.present() || minutesFieldValue.present()
                || monthsFieldValue.present() || nanosecondsFieldValue.present() || secondsFieldValue.present()
                || weeksFieldValue.present() || yearsFieldValue.present();
        ...
        long milliseconds = millisecondsFieldValue.present()
                ? millisecondsFieldValue.value()
                : durationRecord.milliseconds();
        long microseconds = microsecondsFieldValue.present()
                ? microsecondsFieldValue.value()
                : durationRecord.microseconds();
        long nanoseconds = nanosecondsFieldValue.present()
                ? nanosecondsFieldValue.value()
                : durationRecord.nanoseconds();
        TemporalDuration newRecord = new TemporalDuration(years, months, weeks, days, hours, minutes, seconds,
