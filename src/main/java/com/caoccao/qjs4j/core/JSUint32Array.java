...
public final class JSUint32Array extends JSTypedArray {
     ...
     */
    public JSUint32Array(IJSArrayBuffer buffer, int byteOffset, int length) {
    ...
    public static JSObject create(JSContext context, JSValue... args) {
        ...
        if (args.length >= 1) {
            ...
            if (firstArg instanceof JSNumber lengthNum) {
                ...
                if (args.length >= 3 && !(args[2] instanceof JSUndefined)) {
                    ...
                    return context.createJSUint32Array(jsArrayBuffer, byteOffset, length);
                }
                return context.createJSUint32Array(jsArrayBuffer, byteOffset, -1);
                ...
                JSTypedArray newTypedArray = context.createJSUint32Array(length);
                ...
                JSTypedArray jsTypedArray = context.createJSUint32Array(length);
        ...
        return context.createJSUint32Array(length);
    }
