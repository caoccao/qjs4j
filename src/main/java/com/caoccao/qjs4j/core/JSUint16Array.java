...
public final class JSUint16Array extends JSTypedArray {
     ...
     */
    public JSUint16Array(IJSArrayBuffer buffer, int byteOffset, int length) {
        ...
        if (args.length >= 1) {
            ...
            if (firstArg instanceof JSNumber lengthNum) {
                ...
                if (args.length >= 3 && !(args[2] instanceof JSUndefined)) {
                    ...
                    return context.createJSUint16Array(jsArrayBuffer, byteOffset, length);
                }
                return context.createJSUint16Array(jsArrayBuffer, byteOffset, -1);
