...
public enum TemporalCalendarId {
    BUDDHIST("buddhist", true), CHINESE("chinese", false), COPTIC("coptic", true), DANGI("dangi", false), ETHIOAA(
            "ethioaa", true), ETHIOPIC("ethiopic", true), GREGORY("gregory", true), HEBREW("hebrew",
                    true), INDIAN("indian", true), ISLAMIC_CIVIL("islamic-civil", true), ISLAMIC_TBLA("islamic-tbla",
                            true), ISLAMIC_UMALQURA("islamic-umalqura", true), ISO8601("iso8601",
                                    false), JAPANESE("japanese", true), PERSIAN("persian", true), ROC("roc", true);

    private static final int[] CHINESE_LUNAR_YEAR_INFO = {0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554,
            ...
            0x04970, 0x064b0, 0x074a3, 0x0ea50, 0x06b58, 0x05ac0, 0x0ab60, 0x096d5, 0x092e0, 0x0c960, 0x0d954, 0x0d4a0,
            ...
            0x0d260, 0x0ea65, 0x0d530, 0x05aa0, 0x076a3, 0x096d0, 0x04afb, 0x04ae0, 0x0a4d0, 0x1d0b6, 0x0d250, 0x0d520,
            0x0dd45, 0x0b5a0, 0x056d0, 0x055b2, 0x049b0, 0x0a577, 0x0a4b0, 0x0aa50, 0x1b255, 0x06d20, 0x0ada0, 0x14b63};
    private static final int[] CHINESE_LUNAR_YEAR_INFO_EXTENSION_2051_TO_2100 = {0x09370, 0x049f8, 0x04970, 0x064b0,
            0x168a6, 0x0ea50, 0x06b20, 0x1a6c4, 0x0aae0, 0x092e0, 0x0d2e3, 0x0c960, 0x0d557, 0x0d4a0, 0x0da50, 0x05d55,
            0x056a0, 0x0a6d0, 0x055d4, 0x092d0, 0x0a9b8, 0x0a950, 0x0b4a0, 0x0b6a6, 0x0ad50, 0x055a0, 0x0aba4, 0x0a5b0,
            0x052b0, 0x0b273, 0x06930, 0x07337, 0x06aa0, 0x0ad50, 0x14b55, 0x04b60, 0x0a570, 0x054e4, 0x0d160, 0x0e968,
            0x0d520, 0x0daa0, 0x16aa6, 0x056d0, 0x04ae0, 0x0a9d4, 0x0a2d0, 0x0d150, 0x0f252, 0x0d520};
    private static final int[] DANGI_LUNAR_YEAR_INFO = {0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554,
            0x056a0, 0x09ad0, 0x055d2, 0x04ae0, 0x0a5b6, 0x0a4d0, 0x0d250, 0x0da95, 0x0b550, 0x056a0, 0x0ada2, 0x095d0,
            0x04bb7, 0x049b0, 0x0a4b0, 0x0b4b5, 0x06a90, 0x0ad40, 0x0bb54, 0x02b60, 0x095b0, 0x05372, 0x04970, 0x06566,
            0x0e4a0, 0x0ea50, 0x16a95, 0x05b50, 0x02b60, 0x18ae3, 0x092e0, 0x1c8d7, 0x0c950, 0x0d4a0, 0x1d8a6, 0x0b690,
            0x056d0, 0x125b4, 0x025d0, 0x092d0, 0x0d2b2, 0x0a950, 0x0d557, 0x0b4a0, 0x0b550, 0x15555, 0x04db0, 0x025b0,
            0x18573, 0x052b0, 0x0a9b8, 0x06950, 0x06aa0, 0x0aea6, 0x0ab50, 0x04b60, 0x0aae4, 0x0a570, 0x05270, 0x07263,
            0x0d950, 0x06b57, 0x056a0, 0x09ad0, 0x04dd5, 0x04ae0, 0x0a4e0, 0x0d4d4, 0x0d250, 0x0d598, 0x0b540, 0x0d6a0,
            0x195a6, 0x095b0, 0x049b0, 0x0a9b4, 0x0a4b0, 0x0b27a, 0x06a50, 0x06d40, 0x0b756, 0x02b60, 0x095b0, 0x04b75,
            0x04970, 0x064b0, 0x074a3, 0x0ea50, 0x06d98, 0x05ad0, 0x02b60, 0x096e5, 0x092e0, 0x0c960, 0x0e954, 0x0d4a0,
            0x0da50, 0x07552, 0x056c0, 0x0abb7, 0x025d0, 0x092d0, 0x0cab5, 0x0a950, 0x0b4a0, 0x1b4a3, 0x0b550, 0x055d9,
            0x04ba0, 0x0a5b0, 0x09575, 0x052b0, 0x0a950, 0x0b954, 0x06aa0, 0x0ad50, 0x06b52, 0x04b60, 0x0a6e6, 0x0a570,
            0x05270, 0x06a65, 0x0d930, 0x05aa0, 0x0b6a3, 0x096d0, 0x04afb, 0x04ae0, 0x0a4d0, 0x1d0d6, 0x0d250, 0x0d520,
            0x0dd45, 0x0b6a0, 0x096d0, 0x055b2, 0x049b0, 0x0a577, 0x0a4b0, 0x0b250, 0x1b255, 0x06d40, 0x0ada0, 0x18b63};
    ...
    private static final ConcurrentHashMap<TemporalReferenceIsoDateLookupKey, IsoDate> REFERENCE_ISO_DATE_HIT_CACHE = new ConcurrentHashMap<>();
    private static final Queue<TemporalReferenceIsoDateLookupKey> REFERENCE_ISO_DATE_HIT_CACHE_EVICTION_QUEUE = new ConcurrentLinkedQueue<>();
    private static final Set<TemporalReferenceIsoDateLookupKey> REFERENCE_ISO_DATE_MISS_CACHE = ConcurrentHashMap
            .newKeySet();
    private static final Queue<TemporalReferenceIsoDateLookupKey> REFERENCE_ISO_DATE_MISS_CACHE_EVICTION_QUEUE = new ConcurrentLinkedQueue<>();
    private static final LongAdder REFERENCE_ISO_DATE_MISS_CACHE_HIT_COUNT = new LongAdder();
    private static final ConcurrentHashMap<Long, TemporalReferenceIsoDateYearIndex> REFERENCE_ISO_DATE_YEAR_CACHE = new ConcurrentHashMap<>();
    private static final Queue<Long> REFERENCE_ISO_DATE_YEAR_CACHE_EVICTION_QUEUE = new ConcurrentLinkedQueue<>();
    ...
    public IsoDate findBoundaryIsoDateForYearMonth(int targetYear, String targetMonthCode) {
        IsoDate minimumBoundaryIsoDate = findClosestBoundaryIsoDate(this, targetYear, targetMonthCode,
                TemporalConstants.MIN_SUPPORTED_EPOCH_DAY);
        if (minimumBoundaryIsoDate != null) {
            return minimumBoundaryIsoDate;
        } else {
            return findClosestBoundaryIsoDate(this, targetYear, targetMonthCode,
    ...
    IsoDate findReferenceIsoDateAtOrBelow(String monthCode, int maximumDayOfMonth) {
        ...
        for (int candidateDayOfMonth = constrainedMaximumDay; candidateDayOfMonth >= 1; candidateDayOfMonth--) {
            IsoDate candidateReferenceIsoDate = findReferenceIsoDateExact(monthCode, candidateDayOfMonth);
    ...
    IsoDate findReferenceIsoDateExact(String monthCode, int dayOfMonth) {
        ...
        TemporalReferenceIsoDateLookupKey referenceIsoDateLookupKey = new TemporalReferenceIsoDateLookupKey(this,
                monthCode, dayOfMonth);
        ...
        if (resolvedReferenceIsoDate == null) {
            ...
            TemporalUtils.putBoundedSetEntry(REFERENCE_ISO_DATE_MISS_CACHE,
                    REFERENCE_ISO_DATE_MISS_CACHE_EVICTION_QUEUE, referenceIsoDateLookupKey,
                    MAX_REFERENCE_ISO_DATE_CACHE_SIZE);
            return null;
        } else {
            TemporalUtils.putBoundedMapEntry(REFERENCE_ISO_DATE_HIT_CACHE, REFERENCE_ISO_DATE_HIT_CACHE_EVICTION_QUEUE,
                    referenceIsoDateLookupKey, resolvedReferenceIsoDate, MAX_REFERENCE_ISO_DATE_CACHE_SIZE);
    ...
    private IsoDate findReferenceIsoDateExactUncached(String monthCode, int dayOfMonth) {
        for (int isoYear = DEFAULT_REFERENCE_ISO_YEAR; isoYear >= MIN_REFERENCE_ISO_YEAR; isoYear--) {
            IsoDate candidateReferenceIsoDate = findReferenceIsoDateForIsoYear(isoYear, monthCode, dayOfMonth);
            if (candidateReferenceIsoDate != null) {
                return candidateReferenceIsoDate;
            }
        }
    ...
    private IsoDate findReferenceIsoDateForIsoYear(int isoYear, String monthCode, int dayOfMonth) {
        ...
        if (yearIndex == null) {
            ...
            TemporalReferenceIsoDateYearIndex createdYearIndex = TemporalReferenceIsoDateYearIndex.create(this,
                    isoYear);
            TemporalUtils.putBoundedMapEntry(REFERENCE_ISO_DATE_YEAR_CACHE,
                    REFERENCE_ISO_DATE_YEAR_CACHE_EVICTION_QUEUE, calendarYearCacheKey, createdYearIndex,
    ...
    public boolean isCalendarLeapYear(int calendarYear) {
        return switch (this) {
            ...
            case ISLAMIC_UMALQURA -> TemporalConstants.UMALQURA_KNOWN_LEAP_YEARS_1390_TO_1469.contains(calendarYear)
                    || (calendarYear < 1390 || calendarYear > 1469) && umalquraDaysInMonth(calendarYear, 12) == 30;
            case PERSIAN -> IsoGregorianYear.isPersianLeapYear(calendarYear);
            case CHINESE, DANGI -> calendarYear >= 1900 && calendarYear <= getLunisolarMaxYear()
    ...
    private static boolean canParseCalendarLikeString(JSContext context, String calendarLikeText) {
        ...
        if (IsoCalendarDateTime.parseDateTimeString(context, calendarLikeBaseText) != null
        ...
        if (calendarLikeBaseText.length() == 5 && Character.isDigit(calendarLikeBaseText.charAt(0))
                && Character.isDigit(calendarLikeBaseText.charAt(1)) && calendarLikeBaseText.charAt(2) == '-'
    ...
    public static TemporalCalendarId createFromCalendarValue(JSContext context, JSValue calendarValue) {
        ...
        if (firstCalendarAnnotation != null) {
            TemporalCalendarId validatedCalendar = TemporalCalendarId.createFromCalendarString(context,
                    new JSString(firstCalendarAnnotation));
    ...
    private static IsoDate findClosestBoundaryIsoDate(TemporalCalendarId calendarId, int targetYear,
            String targetMonthCode, long boundaryEpochDay) {
    ...
    static TemporalReferenceIsoDateCacheStats getReferenceIsoDateCacheStats() {
        return new TemporalReferenceIsoDateCacheStats(REFERENCE_ISO_DATE_CACHE_HIT_COUNT.sum(),
                REFERENCE_ISO_DATE_CACHE_MISS_COUNT.sum(), REFERENCE_ISO_DATE_MISS_CACHE_HIT_COUNT.sum(),
                REFERENCE_ISO_DATE_YEAR_CACHE_HIT_COUNT.sum(), REFERENCE_ISO_DATE_YEAR_CACHE_MISS_COUNT.sum());
    }
    ...
    record TemporalReferenceIsoDateCacheStats(long hitCount, long missCount, long missCacheHitCount,
            long yearCacheHitCount, long yearCacheMissCount) {
    }
}
