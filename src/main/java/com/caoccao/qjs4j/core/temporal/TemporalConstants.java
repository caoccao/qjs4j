...
/**
 * Centralized constants for the Temporal implementation. Eliminates duplication of nanosecond conversion factors, epoch
 * day boundaries, calendar epoch offsets, and solar day subdivisions across temporal files.
 */
public final class TemporalConstants {
     ...
     */
    public static final BigInteger BI_BILLION;
    ...
    public static final int[] LUNISOLAR_MONTH_LENGTHS_YEAR_1899 = {30, 29, 30, 30, 29, 30, 29, 30, 29, 30, 29, 30};
    public static final BigInteger MAX_ABSOLUTE_TIME_NANOSECONDS = BigInteger.valueOf(9_007_199_254_740_992L)
            .multiply(BI_SECOND_NANOSECONDS).subtract(BigInteger.ONE);
    ...
    public static final Set<Integer> UMALQURA_KNOWN_LEAP_YEARS_1390_TO_1469 = Set.of(1390, 1392, 1397, 1399, 1403, 1405,
            1406, 1411, 1412, 1414, 1418, 1420, 1425, 1426, 1428, 1433, 1435, 1439, 1441, 1443, 1447, 1448, 1451, 1454,
            1455, 1457, 1462, 1463, 1467, 1469);

    static {
        BI_BILLION = BI_SECOND_NANOSECONDS;
    }
