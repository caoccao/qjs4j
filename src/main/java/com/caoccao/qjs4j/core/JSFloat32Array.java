...
public final class JSFloat32Array extends JSTypedArray {
     ...
     */
    public JSFloat32Array(JSContext context, IJSArrayBuffer buffer, int byteOffset, int length) {
        ...
        if (args.length >= 1) {
            ...
            if (firstArg instanceof JSNumber lengthNum) {
                ...
                if (args.length >= 3 && !(args[2] instanceof JSUndefined)) {
                    ...
                    return context.createJSFloat32Array(jsArrayBuffer, byteOffset, length);
                }
                return context.createJSFloat32Array(jsArrayBuffer, byteOffset, -1);
    ...
    public JSTypedArray subarray(int begin, int end) {
        ...
        return new JSFloat32Array(context, buffer, newByteOffset, newLength);
    }
}
